...
const html = `<% if (hcode = "gong" or hcode = "sobang") And (cdate(lo_now_date) >= cdate("2024-09-24") and cdate(lo_now_date) < cdate("2024-10-10")) then %>  
<%' 공무원, 소방 환급/연장 모바일 배너 S %>
