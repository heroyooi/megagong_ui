...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=250,top=100,width=400,height=300,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
	    ...
	    var sPopupUrl = "photo_uploader/popup/photo_uploader.asp?site=project";
