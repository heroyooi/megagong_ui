															  ...
															  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
																	<td height="40" align="right"><a href="javascript:ChkWrite();" onFocus="blur()"><img src="<%=img_main%>/btn/btn_board_save.gif" alt="저장" align="absmiddle"></a>&nbsp;
                                                                       ...
                                                                       <img style="cursor:hand;" onclick="javascript:window.parent.location.href='http://www.megacst.com/cust/cust_sub20.asp?searchkey=<%=searchkey%>&searchword=<%=searchword%>&nextpage=<%=intnextpage%>&page_flag=<%=p_page_flag%>&menu_gubun=<%=gubun%>'; " src="<%=img_main%>/btn/bt_list.gif" alt="목록" align="absmiddle"/>
