    ...
    function html5Upload() {	
    	...
    	sUploadURL= "https://filedev.megagong.net/script/smartEditor3/photo_uploader/popup/file_uploader_html5.asp"
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  :   "https://filedev.megagong.net/script/smartEditor3/photo_uploader/popup/file_uploader.asp" ,    //location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.asp',	//샘플 URL입니다.
