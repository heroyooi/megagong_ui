...
const html = `<div class="mg_slick_wrap s_example_1_wrap">
  <div class="s_example_1">
...
const css = `.s_example_1_wrap{width:750px;}
.s_example_1_wrap .s_example_1{display: none;}
.s_example_1_wrap .s_example_1.slick-initialized{display: block;}
.s_example_1_wrap .slick-slide img{transform:scale(1.05);transition:transform 1.5s cubic-bezier(.58, .36, .84, .87);}
.s_example_1_wrap .slick-slide.slick-active img{transform:scale(1.0);}
.s_example_1_wrap .slick-slide .item .inner{display:block;background-color:rgb(238, 238, 238);padding:50px 0;text-align:center;margin:0 5px;}
.s_example_1_wrap .mg_slick_btn.prev{left:-30px;}
.s_example_1_wrap .mg_slick_btn.next{right:-30px;}

@media screen and (max-width: 810px) {
  .s_example_1_wrap{width:100%;}
}`;

const excCss = `.s_example_1_wrap{max-height:430px;}
.s_example_1_wrap .s_example_1{display:block;}`;

const js = `var Example1 = $('.s_example_1').not('.slick-initialized').slick({
  autoplay: true,
  autoplaySpeed: 3000,
  fade: true,
  dots: false,
...
$('.s_example_1_wrap .mg_slick_btn.prev').on('click', function(e){
  e.preventDefault();
  Example1.slick('slickPrev');
});
$('.s_example_1_wrap .mg_slick_btn.next').on('click', function(e){
  e.preventDefault();
