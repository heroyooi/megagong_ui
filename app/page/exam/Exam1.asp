...
<div id="eventWrap" class="eventWrap">
    ...
    <!-- 메인 S -->
    <!-- 콘텐츠 영역 S -->
    <div id="con1" class="evSection evCon1">
        <div class="inner">
            <h4 class="con_tit">진단평가 완벽 활용</h4>

            <div class="con_box">
                <ol class="step_wrap">
                    <li class="step">
                        <div class="con_tit">
                            <i class="label"><span>STEP 1.</span></i>
                            <h5>응시 정보 입력 후 응시</h5>
                            <div class="sub_tit">직렬 선택 전이라면? <br>직렬 및 과목 소개에서 <span>직렬 선택 꿀팁</span> 확인하세요!</div>
                        </div>

                        <div class="content">
                            <div class="step_slider">
                                <div class="item"><span><img src="<%=img_main%>/m/2024/0708_exam/con1_img01_1.jpg" alt="-"></span></div>
                                <div class="item"><span><img src="<%=img_main%>/m/2024/0708_exam/con1_img01_2.jpg" alt="-"></span></div>
                            </div>
                        </div>
                    ...
                    <li class="step">
                        <div class="con_tit">
                            <i class="label"><span>STEP 2.</span></i>
                            <h5>채점 결과 및 직렬별 합격가능성 확인</h5>
                            <div class="sub_tit"><span>문제별 해설</span>, <br>전 직렬 <span>모집정보</span>까지 확인하세요!</div>
                        </div>

                        <div class="content">
                            <div class="step_slider">
                                <div class="item"><span><img src="<%=img_main%>/m/2024/0708_exam/con1_img02_1.jpg" alt="-"></span></div>
                                <div class="item"><span><img src="<%=img_main%>/m/2024/0708_exam/con1_img02_2.jpg" alt="-"></span></div>
                            </div>
                        </div>
                    ...
                    <li class="step">
                        <div class="con_tit">
                            <i class="label"><span>STEP 3.</span></i>
                            <h5>과목별·단계별 학습 가이드 확인</h5>
                            <div class="sub_tit">다른 <span>과목 학습 전략</span>도 궁금하다면? <br>직렬 및 과목 소개에서 확인하세요!</div>
                        </div>

                        <div class="content">
                            <div class="step_slider">
                                <div class="item"><span><img src="<%=img_main%>/m/2024/0708_exam/con1_img03_1.jpg" alt="-"></span></div>
                                <div class="item"><span><img src="<%=img_main%>/m/2024/0708_exam/con1_img03_2.jpg" alt="-"></span></div>
                            </div>
                        </div>
...
const outJs = ``;
    ...
    return (
      <PageContent
        ...
        outJs={outJs}
        items={["진단평가","응시하기"]}
        link="<%=lab_main%>/l/exam/gong/2024_2/index.asp#eventWrap"
        onChange={onChange}
      />
    )
  }
