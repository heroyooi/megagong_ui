...
'	Uploadform.MaxUploadSize = 524288000
	...
	UploadDir = "E:\megacst\Data\board\on\"   '업로드 경로
   ...
   if UploadFileName<>"" then '업로드 파일이 있다면
                ...
                UploadFileName =  cstr(fncRequestCookie("userid")) + "_" + cstr( date())+ "_" + cstr(hour(now())) + cstr(minute(now())) + cstr(second(now())) + file_style
  ...
  <script language=javascript>
      ...
      location.href = "http://www.gongcampus.com/help/qna/loading.asp?gubun=<%=gubun%>";      
