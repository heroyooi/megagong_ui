...
'
    ...
    data = search
    For cnt = 0 to 14 '필터링 인덱스를 배열 크기와 맞춰준다.
...
function GetSubNewOffDay(sub_cd,dom_cd)
	...
	elseif dom_cd = "5" then
		select case sub_cd
			case "10" :  rv = cdate("2022-05-04")	'10 - 형법
			case "11" :  rv = cdate("2022-05-04")	'11 - 형사소송법
			...
			case "A5" :  rv = cdate("2022-11-z9")	'A5 - 건축계획
		end select
	end if
    ...
    if dom_cd = "" then dom_Cd = h_dcd
   	if dom_cd = "4" then
		...
		' 9급
			...
			case "gosabu88" :  rv = cdate("2022-04-01") '주석처리s
			case "nyuseoul" :  rv = cdate("2022-04-07")
			case "jinsyjin03" :  rv = cdate("2022-04-14")
			case "megalaw" :  rv = cdate("2022-05-04")'백광훈T (2022-05-04일까지 NEW 딱지)
			case "wjsgywls1" :  rv = cdate("2022-05-04")'전효진T (2022-05-04일까지 NEW 딱지)
