...
<div id="eventWrap" class="eventWrap">
    ...
    <div class="evSection evSeries">
        <div class="inner">
            ...
            <div class="con_box">
                <ul id="tabSeries" class="tab_base tab_default">
                    <li <%If Request.QueryString("tab") <= 1 then%> class="on"<%End if%>><a href="javascript:void(0);">직렬선택 tip</a></li>
                    <li <%If Request.QueryString("tab") = 2 then%> class="on"<%End if%>><a href="javascript:void(0);">직렬 특장점(행정)</a></li>
                    <li <%If Request.QueryString("tab") = 3 then%> class="on"<%End if%>><a href="javascript:void(0);">직렬 특장점(기술)</a></li>
                </ul>
                <ul class="panel_base">
                    <li id="tabSeries1" style="display: block;">
                        <div class="box_default tal">
                            직렬 선택은 공무원 시험 준비에서 가장 중요한 결정입니다. <br>
                            공무원은 안정적인 직업인 만큼, 한 직렬에서 긴 시간 동안 근무하게 될 가능성이 크기 때문인데요. <br>
                            또한 향후 어떤 분야에서 근무할지, 어떤 종류의 업무를 수행할지를 결정하는 것이기 때문에 신중하게 고려되어야 합니다. <br><br>
                            개인의 흥미가 있는 직렬을 선택한다면 업무에 대한 만족도가 높기 때문에, 관심과 가치관에 맞는 분야를 선택하는 것이 중요한데요. <br>
                            따라서 직렬을 선택하기에 앞서 임용 후 어떤 업무에 적합할지 본인의 성향과 적성을 파악해야 합니다. <br><br>
                            하지만 아무리 생각해보아도 특정 관심 분야가 없는 경우, 어떤 기준으로 직렬을 선택하는 것이 좋을까요? <br>
                            본인의 흥미나 적성 이외에 직렬을 선택할 때 고려할 점은 <b>선발 규모, 응시 기회, 경쟁률, 근무 환경, 퇴직 후 전망</b> 등이 있습니다.
                        </div>
                        <div class="tip_title tip1">선발규모·응시기회·경쟁률</div>
                        <div class="box_default tal">
                            <b>일반행정, 세무와 같이 선발 규모가 크고 국가직/지방직 복수의 응시 기회를 가질 수 있는 직렬을 선택하는 방법입니다. <br>
                            단, 일반행정은 지원자가 많아 경쟁률과 합격선이 높다는 점은 유의하여야 합니다.</b> <br><br>
                            선거행정, 고용노동, 출입국관리, 보호직은 지방직 시험과 전문과목 1과목이 일치하여 국가직 시험 종료 후 남은 기간 1과목을 추가로 준비하면 지방직의 다른 직렬에 응시할 수 있습니다. <br><br>
                            반대로 교정, 검찰, 관세, 통계직 등은 지방직 시험에는 전문과목이 일치하는 직렬이 없습니다. <br><br>
                            이들 직렬을 선택할 때는 전문과목 2과목을 새롭게 공부하여 지방직의 다른 직렬에 응시하거나, 국가직 시험에만 집중하여 응시해야 합니다.
                        </div>
                        <div class="table_default table_info">
                            <table>
                                <colgroup>
                                    <col style="width: 12%;">
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" class="cr_1">직류</th>
                                        <th scope="col" class="cr_1">선발인원</th>
                                        <th scope="col" class="cr_1">경쟁률</th>
                                        <th scope="col" class="cr_1">전문과목</th>
                                        <th scope="col" class="cr_1">응시기회</th>
                                        <th scope="col" class="cr_1">지방직 응시할 경우</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th scope="row">일반행정(일반)</th>
                                        <td>많음</td>
                                        <td>높은 편</td>
                                        <td rowspan="3">행정법총론, 행정학개론</td>
                                        <td rowspan="3">2회</td>
                                        <td rowspan="3">일반행정 응시 <br>(5과목 완전 일치)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">일반행정(우정)</th>
                                        <td>많음</td>
                                        <td>보통</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">일반행정(경찰)</th>
                                        <td>보통</td>
                                        <td>보통</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">교육행정</th>
                                        <td>많음 <br>(국가직 小/ <br>지방직 多)</td>
                                        <td>높은 편</td>
                                        <td>교육학개론, 행정법총론</td>
                                        <td>2회</td>
                                        <td>교육행정 응시 <br>(5과목 완전 일치)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">선거행정</th>
                                        <td>적음</td>
                                        <td>보통</td>
                                        <td>공직선거법, 행정법총론</td>
                                        <td rowspan="2">2회</td>
                                        <td rowspan="2">일반행정/교육행정 응시 <br>(1과목 추가 학습 필요)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">고용노동</th>
                                        <td>적음</td>
                                        <td>높은 편</td>
                                        <td>노동법개론, 행정법총론</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">직업상담</th>
                                        <td>적음</td>
                                        <td>보통</td>
                                        <td>노동법개론, 직업상담·심리학개론</td>
                                        <td>1회</td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">세무 <br>(지방직:지방세)</th>
                                        <td>많음 <br>(국가직 多/ <br>지방직 지역별 상이)</td>
                                        <td>낮은 편</td>
                                        <td>세법개론(지방직: 지방세법), 회계학</td>
                                        <td>2회</td>
                                        <td>지방세 응시 <br>(5과목 완전 일치)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">관세</th>
                                        <td>보통</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>적음</td>
                                        <td>보통</td>
                                        <td>형사정책개론, 사회복지학개론</td>
                                        <td>2회</td>
                                        <td>사회복지사 자격증 있을 경우 <br>사회복지 응시 가능 <br>(행정법총론 추가 학습 필요)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">검찰</th>
                                        <td>많음</td>
                                    ...
                                    <tr>
                                        <th scope="row">출입국관리</th>
                                        <td>많음</td>
                                        <td>낮은 편</td>
                                        <td>행정법총론, 국제법개론</td>
                                        <td>2회</td>
                                        <td>일반행정/교육행정 응시 <br>(1과목 추가 학습 필요)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">철도경찰</th>
                                        <td>적음</td>
                                        <td>낮은 편</td>
                                        <td>형사소송법개론, 형법총론</td>
                                        <td>1회</td>
                                    ...
                                    <tr>
                                        <th scope="row">사회복지*</th>
                                        <td>많음</td>
                                        <td>낮은 편</td>
                                        <td>사회복지학개론, 행정법총론</td>
                                        <td>1회</td>
                                        <td>*국가직 채용 無, <br>지방직만 응시 가능</td>
                                    </tr>
                                </tbody>
                            </table>
                            <ul class="tiny_noti">
                                <li>※ 선발인원, 경쟁률: 2024년 국가직 9급 채용 기준</li>
                                <li>※ 상세한 선발 인원과 경쟁률은 진단평가 응시 후 결과페이지에서 확인 가능 <br class="show-460"><a href="javascript:;" onclick="goExam();">바로가기 &gt;</a></li>
                            </ul>
                        </div>
                        <div class="tip_title tip2">근무 환경 <span>(근무지, 대민 여부, 워라밸 등)</span></div>
                        <div class="box_default tal">
                            국가직은 중앙부처 등 국가 기관에서 근무하기 때문에 전국 순환 근무를 하게 되고, 지방직은 해당 지방자치단체의 지역 내에서만 발령이 납니다. <br><br>
                            또한 특정 직렬의 경우 대민 업무 비중이 높기 때문에 민원 업무의 비중이 직렬 선택의 기준이 될 수 있습니다. <br><br>
                            민원 업무가 부담스럽다고 느껴진다면 민원 업무 비중이 낮은 일반행정(경찰), 교육행정, 교정, 보호 등의 직렬을, 그렇지 않다면 일반행정, 세무, 고용노동, <br>
                            직업상담, 사회복지 등의 직렬을 선택할 수 있습니다.
                        </div>
                        <div class="table_default">
                            <table>
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" colspan="2" class="cr_1">직류</th>
                                        <th scope="col" class="cr_1">직렬</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th scope="row" rowspan="2">근무지</th>
                                        <th scope="row">전국</th>
                                        <td class="tal">국가직 전 직렬</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">해당 지역</th>
                                        <td class="tal">지방직 전 직렬</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" rowspan="2">대민 업무</th>
                                        <th scope="row">多</th>
                                        <td class="tal">일반행정, 세무, 고용노동, 직업상담, 사회복지</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">少</th>
                                        <td class="tal">일반행정(경찰), 교육행정, 교정, 보호</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" rowspan="2">재해 시 등 <br>비상 대기</th>
                                        <th scope="row">有</th>
                                        <td class="tal">지방직 일반행정, 사회복지</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">無</th>
                                        <td class="tal">국가직 전 직렬</td>
                        ...
                        <div class="tip_title tip3">퇴직 후 전망</div>
                        <div class="box_default tal">일부 직렬은 근속 기간에 따라 자격증 시험 과목을 면제해 주기도 합니다.</div>
                        <div class="table_default">
                            <table>
                                <colgroup>
                                    <col style="width: 34%;">
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" class="cr_1">직렬</th>
                                        <th scope="col" class="cr_1">자격 시험 면제</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th scope="row">세무</th>
                                        <td class="tal">10년 이상 근속 시 세무사 1차 시험 면제</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">관세</th>
                                        <td class="tal">10년 이상 근속한 자 중 5급 이상일 경우 관세사 1차 시험 면제</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">고용노동/직업상담</th>
                                        <td class="tal">10년 이상 근속 시 공인노무사 1차 시험 일부 면제</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">법원/검찰/마약수사</th>
                                        <td class="tal">10년 이상 근속 시 법무사 1차 시험 면제, 7급 이상 공무원 7년, <br>5급 이상 5년 이상 근무는 2차 시험 중 민법/형법/형소법 면제</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <p class="msg tal">어떤 직렬을 선택하느냐에 따라 임용 후의 미래가 달라지게 되므로 위에서 언급하였듯이 <b>관심분야, 선발규모, 근무환경 등을 종합적으로 살펴본 뒤 <br class="hide-1200">가장 최적의 선택을 하시기 바랍니다.</b></p>
                    </li>
                </ul>
            </div>
        </div>
...
const outJs = ``;
    ...
    return (
      <PageContent
        ...
        outJs={outJs}
        items={["진단평가", "직렬선택 가이드"]}
        link="<%=lab_main%>/l/exam/gong/2024_2/series_guide.asp#eventWrap"
        onChange={onChange}
      />
    )
  }
