<script type="text/babel">
  ...
  function BannerLeftSky({ title, onChange }) {
    ...
    <div class="inner">
        ...
        <% if hcode = "gong" then %>
            ...
            <div class="main_sky_banner">
                ...
                <% if cdate(lo_now_date) >= cdate("2024-09-24") and cdate(lo_now_date) < cdate("2024-10-28") then %>
                <div class="item">
        ...
        <% elseif hcode = "sobang" then %>
            ...
            <div class="main_sky_banner">
                ...
                <% If cdate(lo_now_date) >= cdate("2024-09-10") and cdate(lo_now_date) < cdate("2024-10-01") then %>
                <div class="item">
        ...
        <div class="main_sky_banner no_slick type-2 top_re">
            ...
            <div class="tec-recruit">
                ...
                <div class="tiny-slide">
                    ...
                    <% if hcode = "gong" and cdate(lo_now_date) >= cdate("2024-10-01") and cdate(lo_now_date) < cdate("2024-10-19 14:00") then%>
                    <div class="item">
...
$(function(){ // html 파싱 이후
    ...
    return (
      <PageContent
        ...
        excCss={excCss}
        js={js}
        items={["좌측 상단 배너","메인 배너"]}
        link="<%=url_main%>/megagong.asp"
        file="common\banner\left_sky_banner.asp"
        onChange={onChange}
      />
    )
  }
