...
<div id="eventWrap" class="eventWrap">
    ...
    <div id="apply_info" class="evSection apply_info">
        <div class="inner">
            ...
            <div class="box_default">
                ...
                <div class="info_wrap">
                    ...
                    <div class="info flex">
                        ...
                        <div class="info_content">
                            <ul class="radio_list">
                                <li>
                                    <label for="examinee_1">
                                        <input type="radio" name="examinee" id="examinee_1" value="1"/>
                                        예비 수험생(학습 시작 안 함)
                                    </label>
                                </li>
                                <li>
                                    <label for="examinee_2">
                                        <input type="radio" name="examinee" id="examinee_2" value="2"/>
                                        초시생(학습 시작함)
                                    </label>
                                </li>
                            </ul>
                    ...
                    <div class="info">
                        ...
                        <table class="info_table">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="select_box">
                                            <select name="dpt1_part1" id="dpt1_part1">
                                                ...
                                                <option value="1">행정직군</option>
                                                <option value="2">기술직군</option>
                                ...
                                <tr>
                                    ...
                                    <td id="special_subj">-</td>
                                </tr>
                                <tr id="dpt_part_select_show" style="display:none;">
                                    <th scope="row"><div><span id="special_subj_1" class="cr_red">행정법총론</span> <br />배경 지식<span class="cr_red">*</span> 보유 여부</div></th>
                                    <td>
                                        <div class="select_box">
                                    ...
                                    <th scope="row"><div><span id="special_subj_2" class="cr_red">행정학개론</span> <br />배경 지식<span class="cr_red">*</span> 보유 여부</div></th>
                                    <td>
                                        <div class="select_box">
                        ...
                        <div class="tiny_pop"><span class="cr_red">*</span> 관련 학과 재학 및 졸업, 타 시험 준비로 전문과목 배경 지식이 있는 경우 “있음” 선택 <a href="#" onclick="openMegaPopup('seriesPop', 1); return false;">전 직렬 전문과목 보기 &gt;</a></div>
                    </div>
                    <div class="info">
                        ...
                        <table class="info_table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="select_box">
                                            <select name="ans1" id="ans1">
                                                <option value="">선택</option>
                                                <option value="1">연봉/성과급/수당이 높아서</option>
                                                <option value="2">고용안정성 때문에</option>
                                                <option value="3">복지제도/복지혜택이 좋아서</option>
                                                <option value="4">워라밸이 잘 지켜질 것 같아서</option>
                                                <option value="5">연금 등 노후 준비가 가능해서</option>
                                                <option value="6">업무적성과 잘 맞을 것 같아서</option>
                                                <option value="7">주변의 권유</option>
                                                <option value="8">채용공정성이 높아서</option>
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="select_box">
                                            <select name="ans3" id="ans3">
                                                <option value="">선택</option>
                                                <option value="1">채용 인원이 많아서</option>
                                                <option value="2">평소에 관심 많은 직렬이어서</option>
                                                <option value="3">응시 과목이 전공과 연관 있어서</option>
                                                <option value="4">경쟁률이 낮아서</option>
                                                <option value="5">합격선이 낮아서</option>
                                                <option value="6">경력과 연관 있어서</option>
                                            </select>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="select_box">
                                            <select name="ans4" id="ans4">
                                                <option value="">선택</option>
                                                <option value="1">고등학교 재학</option>
                                                <option value="2">고등학교 졸업</option>
                                                <option value="3">대학(2,3년제) 재학</option>
                                                <option value="4">대학(2,3년제) 휴학</option>
                                                <option value="5">대학(2,3년제) 졸업</option>
                                                <option value="6">대학(4년제) 재학</option>
                                                <option value="7">대학(4년제) 휴학</option>
                                                <option value="8">대학(4년제) 졸업</option>
                                                <option value="9">대학원 재학 또는 졸업</option>
                                            </select>
                                        </div>
                                    </td>
                                </tr>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div class="select_box">
                                                ...
                                                <select name="ans5" id="ans5">
                                                    ...
                                                    <option value="0">없음(모름)</option>
                                                </select>
                                            </div>
                                            <div class="select_box">
                                                영어
                                                <select name="ans6" id="ans6">
                                                    <option value="">선택</option>
                                                    <option value="1">1등급</option>
                                                    <option value="2">2등급</option>
                                                    <option value="3">3등급</option>
                ...
                <div class="info_btn">
                    <a href="javascript: void(0);" onclick="setMemInfoX();">저장하기</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- 전 직렬 전문과목 팝업 S -->
    <div class="mg_popup_wrap interest_pop z-anim mfp-hide series_pop" id="seriesPop" data-width="700">
        <div class="content_area">
            <div class="content_inner table_default">
                <table>
                    <colgroup>
                    ...
                    <thead>
                        <tr>
                            <th scope="col" class="cr_1">직렬</th>
                            <th scope="col" class="cr_1">전문과목1</th>
                            <th scope="col" class="cr_1">전문과목2</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <th scope="row" class="cr_2">일행-전국</th>
                            <td>행정법총론</td>
                            <td>행정학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">일행(우정)-서울</th>
                            <td>행정법총론</td>
                            <td>행정학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">일행(우정)-인천·경기</th>
                            <td>행정법총론</td>
                            <td>행정학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">일행(경찰)</th>
                            <td>행정법총론</td>
                            <td>행정학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">고용노동</th>
                            <td>노동법개론</td>
                            <td>행정법총론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">교육행정</th>
                            <td>교육학개론</td>
                            <td>행정법총론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">선거행정</th>
                            <td>공직선거법</td>
                            <td>행정법총론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">직업상담</th>
                            <td>노동법개론</td>
                            <td>직업상담·심리학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">세무</th>
                            <td>세법개론</td>
                            <td>회계학</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">관세</th>
                            <td>관세법개론</td>
                            <td>회계원리</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">통계</th>
                            <td>통계학개론</td>
                            <td>경제학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">교정(남)</th>
                            <td>교정학개론</td>
                            <td>형사소송법개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">교정(여)</th>
                            <td>교정학개론</td>
                            <td>형사소송법개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">보호(남)</th>
                            <td>형사정책개론</td>
                            <td>사회복지학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">보호(여)</th>
                            <td>형사정책개론</td>
                            <td>사회복지학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">검찰</th>
                            <td>형법</td>
                            <td>형사소송법</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">마약수사</th>
                            <td>형법</td>
                            <td>형사소송법</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">출입국관리</th>
                            <td>행정법총론</td>
                            <td>국제법개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">철도경찰</th>
                            <td>형사소송법개론</td>
                            <td>형법총론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">건축</th>
                            <td>건축계획</td>
                            <td>건축구조</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">데이터</th>
                            <td>데이터베이스론</td>
                            <td>알고리즘</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">방재안전</th>
                            <td>재난관리론</td>
                            <td>안전관리론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">산림자원</th>
                            <td>조림</td>
                            <td>임업경영</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">시설조경</th>
                            <td>조경학</td>
                            <td>조경계획 및 설계</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">일반기계</th>
                            <td>기계일반</td>
                            <td>기계설계</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">일반농업</th>
                            <td>재배학개론</td>
                            <td>식용작물</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">일반토목</th>
                            <td>응용역학개론</td>
                            <td>토목설계</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">전기</th>
                            <td>전기이론</td>
                            <td>전기기기</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">전산개발</th>
                            <td>컴퓨터일반</td>
                            <td>정보보호론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">전송기술</th>
                            <td>전자공학개론</td>
                            <td>무선공학개론</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">정보보호</th>
                            <td>네트워크보안</td>
                            <td>정보시스템보안</td>
                        </tr>
                        <tr>
                            <th scope="row" class="cr_2">화공</th>
                            <td>화학공학일반</td>
                            <td>공업화학</td>
                        </tr>
                    </tbody>
...
const js = `$("#dpt1_part1").change(() => {changeDpt(); changeDpt2();});    // 직군 선택 시
$("#dpt1_part2").change(() => changeDpt2());   // 직렬 선택 시

// 직렬 select box 값을 가져옴
function changeDpt() {
    var dpt1_part1 = $("#dpt1_part1").val();

    if (dpt1_part1 == '') {
        $("#dpt1_part2").html("<option value=''>선택</option>");
        return;
    }

    if (dpt1_part1 == '0') {
        $("#dpt1_part2").html("<option value=''>선택</option><option value='0' selected>미정</option>");
    ...
    var params = {
        mode: "getDpt2List",
        dpt1_part1: dpt1_part1,
        now: "2024-07-16 11:06:44"
    }
    $.ajax({
        type: "POST",
        url: "./get_info.asp",
        ...
        if(data.result == "succ") {
            ...
            data.proc_data.forEach(el => html += "<option value='" + el.dpt2Code + "'>" + el.dpt2Name + "</option>");
            html += "<option value='0'>미정</option>";
        }
        $("#dpt1_part2").html(html);
    });
}
...
function changeDpt2() {
    var dpt1_part1 = $("#dpt1_part1").val();
    var dpt1_part2 = $("#dpt1_part2").val();

    // console.log(dpt1_part1, dpt1_part2)

    if (!dpt1_part1 || !dpt1_part2 || dpt1_part2 == '0') {
        $("#special_subj").html('-');
        $("#dpt_part_select_show").hide();
        return;
    }

    var params = {
        mode: "getDpt2Subj",
        dpt1_part2: dpt1_part2,
        now: "2024-07-16 11:06:44"
    }
    $.ajax({
        type: "POST",
        ...
        if(data.result == "succ") {
            $("#special_subj").html(data.selSubj);
            $("#special_subj_1").html(data.selSubj1);
            $("#special_subj_2").html(data.selSubj2);
            $("#dpt_part_select_show").show();
        }
    });
}

function setMemInfoX() {
    var examinee = $("input[name=examinee]:checked").val();     // 수험구분
    var dpt1_part1 = $("#dpt1_part1").val();    // 직군
    var dpt1_part2 = $("#dpt1_part2").val();    // 직렬
    var dpt2_part1 = $("#dpt2_part1").val();    // 행정법총론 배경지식 보유여부
    var dpt2_part2 = $("#dpt2_part2").val();    // 행정학개론 배경지식 보유여부
    var ans1 = $("#ans1").val();    // 공무원 준비 이유
    var ans2 = $("#ans2").val();    // 목표 수험기간
    var ans3 = $("#ans3").val();    // 직렬 선택 이유
    var ans4 = $("#ans4").val();    // 최종 학력
    var ans5 = $("#ans5").val();    // 수능등급 - 국어
    var ans6 = $("#ans6").val();    // 수능등급 - 영어
    var ans7 = $("#ans7").val();    // 수능등급 - 한국사

    if (!examinee) {
        alert("수험 구분을 선택해 주세요.");
        return;
    }
    ...
    if (dpt1_part2 != '0') {  // 직렬 미정이 아닐 때만
        if (!dpt2_part1 || !dpt2_part2) {
            alert("전문과목 배경 지식 보유 여부를 선택해 주세요.");
            return;
        }
    }

    if (!ans1) {
        alert("공무원 준비 이유를 선택해 주세요.");
        return;
    }

    if (!ans2) {
        alert("목표 수험 기간을 선택해 주세요.");
        return;
    }

    if (!ans3) {
        alert("직렬 선택 이유를 선택해 주세요.");
        return;
    }
    ...
    if (!ans5 || !ans6 || !ans7) {
        alert("수능 등급을 모두 선택해 주세요.");
        return;
    }

    if (!confirm('응시 정보를 저장하시겠습니까? 응시 후에는 수정할 수 없습니다.')) {
        return;
    }
    ...
    var form_data = {
        ...
        , "dpt1_part1" : dpt1_part1
        , "dpt1_part2" : dpt1_part2
        , "dpt2_part1" : dpt2_part1
        , "dpt2_part2" : dpt2_part2
        , "ans1" : ans1
        , "ans2" : ans2
        , "ans3" : ans3
        , "ans4" : ans4
    ...
    $.post("./apply_proc.asp",form_data,function(data) {
        if(data["msg"] != "") {
            alert(data["msg"]);
        }
        
        if(data["result"]=="succ") {
            // location.replace("./apply_start.asp");
            location.replace("./after_select.asp");
        } else {
...
const outJs = ``;
    ...
    return (
      <PageContent
        ...
        outJs={outJs}
        items={["진단평가","응시 정보 입력"]}
        link="<%=lab_main%>/l/exam/gong/2024_2/before_select.asp#eventWrap"
        onChange={onChange}
      />
    )
  }
