<!-- #include virtual="/Player/kollus/common/lib/json2.asp" -->
<%
...
Function createWebtoken2(service_account_key, results)
...
Dim sha256
Set sha256 = GetObject( "script:" & Server.MapPath("/Player/kollus/common/lib/sha256.wsc") )
sha256.hexcase = 0
Dim Return : result = ""
