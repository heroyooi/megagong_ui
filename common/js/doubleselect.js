DoubleSelect = function(selld1, selld2, url, optionParam) {
	this.select1 = document.getElementById(selld1);
	this.select2 = document.getElementById(selld2);

	this.url = url;
	this.optionParam = (optionParam == null) ? null : optionParam;

	ajax.Event.addListener(this.select1, "change", ajax.Event.bindAsListener(this.doChange, this));
}
