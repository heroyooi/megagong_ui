<script type="text/babel">
  ...
  function DevPopup2({ title, onChange }) {

const html = `<div class="pop_btn_wrap">
  <a class="mg_btn_base sm" href="javascript:;" onclick="openSamplePopup2();">개발 팝업 - 2개 중복 시</a>
</div>
...
const js = `function openSamplePopup2() {
  ...
  closeSamplePopup2();
    ...
    return (
      <PageContent
        ...
        excCss={excCss}
        js={js}
        items={["개발대응2","개발팝업중복시","딤드","딤클릭시경고창"]}
        onChange={onChange}
      />
    )
  }
